...
## Terraform Aliases
alias tf15='tfenv use 0.15.0; echo "Terraform Verson: "; tfenv version-name'
alias tf146='tfenv use 0.14.6; echo "Terraform Verson: "; tfenv version-name'
alias tf135='tfenv use 0.13.5; echo "Terraform Verson: "; tfenv version-name'